...
/**
 * This function checks if the current [Identified] instance does not identify the [other] [Identified] instance.
 * This means both instances do not have the same [java.util.UUID] behind their [Identified.identity].
 * @param other The [Identified] instance to compare with.
 * @return `true` if both instances do not have the same UUID, otherwise `false`.
 * @see Identified.identity
 * @see net.kyori.adventure.identity.Identity.uuid
 * @see Identified.identifies
 * @author Fruxz
 * @since 2025.7
 */
infix fun Identified.identifiesNot(other: Identified): Boolean =
